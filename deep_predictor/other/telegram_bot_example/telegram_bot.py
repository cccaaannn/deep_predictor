...
from telegram_bot_example.deep_predictor_telegram import deep_predictor_telegram
from telegram_bot_example.my_bot_key import botkey
...
def image_handler(update, context):
    try:    
        ...
        is_detection_ok, image_class, labeled_image = dp.predict_image_darknet2(image_path)
